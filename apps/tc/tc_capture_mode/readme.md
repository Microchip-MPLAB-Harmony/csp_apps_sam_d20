...
- TC3 generates the PWM waveform on pin PA19
  - TC3 output is routed using EIC and EVSYS to TC4 input event line
- TC4 is configured in capture mode
  - Capture trigger is provided by input event line
- Use a jumper wire to connect "Pin 18 of EXT2 (TC3_W01)" to "Pin 17 of EXT2 (EIC_EXTINT0)"
...
5. Frequency is constant (799 Hz) and duty cycle changes by 1%
